...
int koef23 = 1141; //Коефіцієнт для розрахунку відстані 200 шагів за оборот
float currentPosition23 = -1; //поточна відстань
int direct;
int previousDirect = -1;
float luftSteps = 0; //кількість кроків на люфт
char text_char[4];
char text_char2[4];
...
void setup()
{
  ...
  nema23.setMaxSpeed(3000);
  nema23.setSpeed(1200);  
  nema23.setAcceleration(2500); //прискорення 3500 for nema23
